...
static void log_eventclass_toggle_impl(enum dmesg_log_eventclass eventclass, int duration_ticks) {
...
void dmesg_init() {
  ...
  tail = buffer;
  *tail = '\0';
  for (int eventclass = 0; eventclass < DMESG_LOG_EVENTCLASS_COUNT; ++eventclass)
